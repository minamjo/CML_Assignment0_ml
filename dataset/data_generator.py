...
if __name__ == "__main__":
    ...
    num_img_get = len(in_dataset) # up to len(in_dataset)
    for i in range(num_img_get):
        ...
        for sample0 in [input_img,label_img]:
            ...
            if sample0 is input_img:
                cv2.imwrite('input/img/input_image_%d.png' % show_example_id, 255*bg)
            else:
                cv2.imwrite('label/img/label_image_%d.png' % show_example_id, 255*bg)
